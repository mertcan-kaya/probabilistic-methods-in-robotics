...
copyobj(plt_t0,ax3)
copyobj(plt_t1_pst,ax3)
plt_t1_bar(1) = plot(x_vec_t1_bar(1,:),x_vec_t1_bar(2,:),'.r');
copyobj(plt_t1_bar(2),ax3)
copyobj(plt_t1_bar(3),ax3)
...
h = legend([plt_z_t1(1:2),plt_t1],'$z_1$','$UE_{z_1,95\%}$','$UE_{1,95\%}$','$\mu_1$');
set(h,'interpreter','Latex','FontSize',12)
...
copyobj(plt_qvr,ax5)
copyobj(plt_t0(2:3),ax5)
copyobj(plt_t1_pst(2:3),ax5)
copyobj(plt_t1_bar(2:3),ax5)
copyobj(plt_t1_act,ax5)
plt_z_t1_f5(1,:) = copyobj(plt_z_t1,ax5);
plt_t1_f5(1,:) = copyobj(plt_t1,ax5);

h = legend([plt_z_t1_f5(1:2),plt_t1_f5],'$z_1$','$UE_{z_1,95\%}$','$UE_{1,95\%}$','$\mu_1$');
set(h,'interpreter','Latex','FontSize',12)
...
h = legend(plt_p,'$p(x_0)$','$p(x`_1)$','$p(\bar{x}_1)$','$p(z_1)$','$p(x_1)$');
set(h,'interpreter','Latex','FontSize',12)
